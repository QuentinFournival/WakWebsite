<template>
    <a-layout>
        ...
        <a-layout-content class="content" :style="{ marginTop: '80px' }">
            <div class="content">
                <div class="card" @click="router.push('/selectServerASE')">
                    <img :src="gifWak" class="logoASE" alt="logo" />
                    <h2>ARK Survival Evolved</h2>
                </div>
                <div class="card" @click="router.push('/selectServerASA')">
...
import gifWak from "../assets/WAKANIM2.gif";
