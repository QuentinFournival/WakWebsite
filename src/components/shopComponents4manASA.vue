...
7 Flak Box (2 bp)</p>
    ...
    },
    {
        ...
        description: `<div class="mt-5">
                        <h4>Description</h4>
                        <p>The <span style="color:rgb(250,197,28);">VIP Mastercraft&nbsp;</span>will give you:</p><p>- 60 000 points</p><p>- More interval in game (25 default ----&gt; 90) per 15 min<br><br>-10% discount IN GAME SHOP on all</p><p>- Exclusive Kit (details below)</p><p>- New role on Discord <span style="color:rgb(250,197,28);">Mastercraft VIP&nbsp;</span><br><br>-Unlimited dino color<br><br><br>Kits:<br>Kits boss:<br>All artefact/tribute for boss<br><br>Kits Uitilites<br>(blueprint parachute, arrow, bolas)<br><br>8 Ressource Box (2 item of BlackPearl/Cementing/Elec/oil/Poly/Silica)<br><br>
4 Saddle Box (2 bp)<br><br>
3 Weapon Box (2 bp)<br><br>
3 Flak Box (2 bp)<br><br></p>
                    </div>`,
        price: 39.98,
        unit_amount: 3998,
        quantity: 1,
    ...
    },
    {
        ...
        description: `<div class="mt-5">
                        <h4>Description</h4>
                        <p>The <span style="color:rgb(85,57,130);">VIP_Journeyman&nbsp;</span>will give you:</p><p>- 25 000 points</p><p>- More interval in game (25 default ----&gt; 50) per 15 min<br><br>-5% discount IN GAME SHOP on all</p><p>- Exclusive Kit (details below)</p><p>- New role on Discord <span style="color:rgb(85,57,130);">VIPJourneyman</span><br><br>Kits:<br>Kits boss:<br>All artefact/tribute for boss<br><br>Kits Uitilites<br>(blueprint parachute, arrow, bolas)<br><br>4 Ressource Box (2 item of BlackPearl/Cementing/Elec/oil/Poly/Silica)<br><br>
2 Saddle Box (2 bp)<br><br>
1 Weapon Box (2 bp)<br><br>
1 Flak Box (2 bp)</p>
                    </div>`,
        price: 19.99,
        unit_amount: 1999,
